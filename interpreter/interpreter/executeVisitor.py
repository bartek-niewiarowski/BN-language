...
class ExecuteVisitor(Visitor):
    ...
    def visit_return_statement(self, element, context: Context) -> None:
    ...
    def visit_or_expression(self, element: OrExpression, context) -> None:
    ...
    def visit_and_expression(self, element: AndExpression, context: Context) -> None:
        x = element.nodes[0].accept(self, context)
        for node in element.nodes[1:]:
            temp_cond = isinstance(x, np.ndarray)
    ...
    def visit_equal_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) == element.right.accept(self, context)

    def visit_not_equal_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) != element.right.accept(self, context)

    def visit_greater_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) > element.right.accept(self, context)

    def visit_greater_equal_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) >= element.right.accept(self, context)

    def visit_less_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) < element.right.accept(self, context)

    def visit_less_equal_operation(self, element, context: Context) -> None:
        return element.left.accept(self, context) <= element.right.accept(self, context)

    def visit_literal_bool(self, element: LiteralBool, context) -> None:
        return element.value

    def visit_literal_int(self, element: LiteralInt, context) -> None:
        return element.value

    def visit_literal_float(self, element: LiteralFloat, context) -> None:
        return element.value

    def visit_literal_string(self, element: LiteralString, context) -> None:
        return element.value
    ...
    def visit_assignment(self, element: Assignment, context: Context) -> None:
        try:
    ...
    def visit_function_call(self, element, context: Context) -> None:
